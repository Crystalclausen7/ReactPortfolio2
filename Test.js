                    ...
                    <div className="container" style={{flexBasis: 'content'}}>
                        ...
                        <div className="text-center mt-4">
                            <a className="btn btn-xl btn-outline-light" href={resume} target="_blank" rel="noopener noreferrer"><i
                                className="fas fa-download mr-2"></i>Crystal Clausen Resume Download</a>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="container">
                        ...
                        <div className="row projectRow">
                            <div className="col-md-6 col-lg-4 mb-5">
                                ...
                                <div><a href="https://github.com/Crystal Clausen/passwordGenerator" target="_blank" rel="noopener noreferrer">GitHub
                            repository</a><br /><a href="https://Crystal Clausen.github.io/passwordGenerator/"
                            ...
                            <div className="col-md-6 col-lg-4 mb-5">
                                ...
                                <div><a href="https://github.com/Crystal Clausen/StoresNearBy" target="_blank" rel="noopener noreferrer">GitHub
                            repository</a><br /><a href="https://Crystal Clausen.github.io/StoresNearBy/"
                                        target="_blank" rel="noopener noreferrer">Deployed version</a></div>
                            </div>
                            <div className="col-md-6 col-lg-4 mb-5">
                                <div className="portfolio-item mx-auto">
                                ...
                                <div><a href="https://github.com/Crystal Clausen/WorkDayScheduler" target="_blank" rel="noopener noreferrer">GitHub
                            repository</a><br /><a href="https://Crystal Clausen.github.io/WorkDayScheduler/"
                                        target="_blank" rel="noopener noreferrer">Deployed version</a></div>
                            </div>
                        </div>
                    </div>
